...
{
    /// <summary>
    /// Versione base (Fael): nessun Name, nessun Error event, nessun MonitorErrors,
    /// logger statico globale, disconnect aggressivo su InvalidOperationException.
    /// </summary>
    public class FaelTcpClient
    {
        ...
        public async Task<ReadResult> ReadAsync(int timeout = -1)
        {
            ...
            {
                // FAEL: disconnect aggressivo su InvalidOperationException
